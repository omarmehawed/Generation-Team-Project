...
<body class="font-cairo text-gray-100 bg-dark antialiased transition-colors duration-300" x-data="{ 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-4">
                    <div class="relative w-12 h-12 rounded-xl overflow-hidden shadow-lg border border-blue-500/30">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="#home" class="text-sm font-bold hover:text-blue-500 transition-colors"
                        :class="{'text-gray-600': !darkMode, 'text-gray-300': darkMode}">الرئيسية</a>
                    <a href="#team" class="text-sm font-bold hover:text-blue-500 transition-colors"
                        :class="{'text-gray-600': !darkMode, 'text-gray-300': darkMode}">عن الفريق</a>
                    <a href="#project" class="text-sm font-bold hover:text-blue-500 transition-colors"
                        :class="{'text-gray-600': !darkMode, 'text-gray-300': darkMode}">عن المشروع</a>
                    <a href="{{ route('join.create') }}" class="text-sm font-bold hover:text-blue-500 transition-colors"
                        :class="{'text-gray-600': !darkMode, 'text-gray-300': darkMode}">انضم إلينا</a>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('login') }}"
                        class="px-6 py-2 rounded-full font-bold text-sm transition-all duration-300 border border-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]"
                        :class="{'text-blue-600 hover:bg-blue-50': !darkMode, 'text-blue-400 hover:bg-blue-500/10': darkMode}">
                        تسجيل الدخول
                    </a>
                </div>
            </div>
    ...
    <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="overlay" :class="{'bg-white/40': !darkMode, 'bg-dark/80': darkMode}"></div>

        <div class="relative z-10 text-center px-4 max-w-5xl mx-auto">
            <div class="animate-fade-in space-y-8">
                <!-- Branding Badge -->
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-blue-500/30 text-blue-400 text-sm font-bold mb-4 animate-slide-up">
                ...
                <!-- Quote -->
                <div class="max-w-3xl mx-auto bg-black/30 backdrop-blur-sm p-6 rounded-2xl border-r-4 border-blue-500 mb-8 animate-slide-up"
                    style="animation-delay: 0.4s"
                    :class="{'bg-white/60 text-gray-800': !darkMode, 'bg-black/30 text-gray-200': darkMode}">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-6 animate-slide-up"
                    ...
                    <a href="{{ route('join.create') }}"
                        class="group relative px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold text-lg transition-all hover:scale-105 shadow-[0_0_30px_rgba(37,99,235,0.5)]">
        ...
        <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
            <a href="#team" class="text-blue-500 text-2xl">
    ...
    <section id="team" class="py-24 relative overflow-hidden" :class="{'bg-white': !darkMode, 'bg-dark': darkMode}">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold mb-4">عن <span class="text-blue-500">الفريق</span></h2>
                <div class="w-24 h-1 bg-blue-500 mx-auto rounded-full"></div>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <!-- Text Content -->
                <div class="space-y-6 text-right order-2 lg:order-1">
                    <h3 class="text-2xl font-bold text-blue-400">Generation Team</h3>
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-8">
                        <div class="p-4 rounded-xl border hover-card"
                            :class="{'bg-gray-50 border-gray-200': !darkMode, 'bg-gray-800/50 border-gray-700': darkMode}">
                            <i class="fas fa-users text-3xl text-blue-500 mb-3"></i>
                            <h4 class="font-bold text-xl">عمل جماعي</h4>
                            <p class="text-sm opacity-70">بيئة تعاونية محفزة</p>
                        </div>
                        <div class="p-4 rounded-xl border hover-card"
                            :class="{'bg-gray-50 border-gray-200': !darkMode, 'bg-gray-800/50 border-gray-700': darkMode}">
                            <i class="fas fa-lightbulb text-3xl text-yellow-500 mb-3"></i>
                            <h4 class="font-bold text-xl">ابتكار</h4>
                ...
                <div class="relative order-1 lg:order-2 flex justify-center">
                    <div
                        class="relative w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-blue-500 shadow-[0_0_50px_rgba(59,130,246,0.3)] animate-float">
    ...
    <section id="project" class="py-24" :class="{'bg-gray-50': !darkMode, 'bg-gray-900': darkMode}">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold mb-4">عن <span class="text-blue-500">المشروع</span></h2>
                <div class="w-24 h-1 bg-blue-500 mx-auto rounded-full"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                ...
                <div class="p-8 rounded-3xl border hover-card group"
                    ...
                    <div
                        class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-500 group-hover:text-white transition-colors duration-300">
                        <i class="fas fa-microchip text-3xl text-blue-500 group-hover:text-white"></i>
                    </div>
                ...
                <div class="p-8 rounded-3xl border hover-card group"
                    :class="{'bg-white border-gray-200': !darkMode, 'bg-gray-800 border-gray-700': darkMode}">
                    <div
                        class="w-16 h-16 bg-purple-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-purple-500 group-hover:text-white transition-colors duration-300">
                        <i class="fas fa-brain text-3xl text-purple-500 group-hover:text-white"></i>
                    </div>
                ...
                <div class="p-8 rounded-3xl border hover-card group"
                    :class="{'bg-white border-gray-200': !darkMode, 'bg-gray-800 border-gray-700': darkMode}">
                    <div
                        class="w-16 h-16 bg-green-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-green-500 group-hover:text-white transition-colors duration-300">
                        <i class="fas fa-cogs text-3xl text-green-500 group-hover:text-white"></i>
                    </div>
                ...
                <!-- Card 6 -->
                <div
                    class="p-8 rounded-3xl border bg-gradient-to-br from-blue-600 to-blue-800 text-white hover-card transform scale-105 shadow-2xl">
                    <div class="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-rocket text-3xl text-white"></i>
                    </div>
                    <h3 class="text-xl font-bold mb-4">Join The Future</h3>
                    <p class="opacity-90 text-sm mb-6">هل أنت مستعد لتكون جزءاً من هذا التحدي؟ انضم إلينا الآن.</p>
                    <a href="{{ route('join.create') }}"
                        class="inline-block px-6 py-2 bg-white text-blue-800 font-bold rounded-full hover:bg-gray-100 transition-colors">
                        قدم الآن
                    </a>
                </div>
    ...
    <footer class="py-8 text-center text-sm border-t"
        :class="{'bg-white border-gray-200 text-gray-600': !darkMode, 'bg-dark border-gray-800 text-gray-500': darkMode}">
        <p>Copyright © 2026 <span class="text-blue-500 font-bold">Generation Team</span>. All rights reserved.</p>
    </footer>
