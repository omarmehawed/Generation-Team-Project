...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-800 dark:text-gray-200">Projects Dashboard</h1>
                <p class="text-gray-500 dark:text-gray-400 mt-1 text-sm">Manage your academic projects & collaborations.</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-10 relative group">
            ...
            <div class="p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Graduation Project 2025</h2>
                        <p class="text-gray-500 dark:text-gray-400 max-w-xl leading-relaxed">
                            Start your final year journey here. Form your team, submit your proposal to <span
                                class="font-semibold text-gray-700 dark:text-gray-300">Dr. Osama El-Nahas</span>, and track your milestones.
                        </p>
                        <div class="mt-4 flex items-center gap-2">
                            <span class="flex w-3 h-3 bg-gray-300 rounded-full"></span>
                            <span class="text-sm text-gray-500 dark:text-gray-400 font-medium">Status: Not Registered</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-3 w-full md:w-auto">
                    ...
                    <a href="#"
                        class="text-gray-600 dark:text-gray-400 hover:text-gray-900 font-medium text-center text-sm underline decoration-gray-300 underline-offset-4">
                        Download Guidelines
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @forelse($courses as $course)
                ...
                <!-- بداية الكارت -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group relative">
                    ...
                    <!-- اسم المادة -->
                    <h4 class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-2 group-hover:text-{{ $iconColor }}-600 transition-colors">
                        {{ $course->name }}
                    </h4>

                    <!-- تفاصيل المشروع -->
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-6 line-clamp-2 min-h-[40px]">
            ...
            @empty
                ...
                <div
                    class="col-span-3 flex flex-col items-center justify-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-dashed border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400">
