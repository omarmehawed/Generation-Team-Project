...
<div id="createTeamModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-gray-100 dark:border-gray-700">
            <form action="{{ route('teams.store') }}" method="POST">
                ...
                <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-2xl font-black text-gray-900 dark:text-gray-100">Create Team</h3>
                    </div>
                    <div class="mb-2">
                        ...
                        <input type="text" name="name" required placeholder="e.g. The Avengers"
                            class="w-full border-2 border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl focus:ring-0 focus:border-[#266963] focus:bg-white outline-none transition shadow-inner text-lg font-bold text-gray-800 dark:text-gray-200 placeholder-gray-300">
                    </div>
                </div>
                <div class="bg-gray-50 dark:bg-gray-900 px-8 py-5 flex flex-row-reverse gap-3">
                    <button type="submit"
                    ...
                    <button type="button" onclick="closeModal('createTeamModal')"
                        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 py-3 px-6 rounded-xl font-bold hover:bg-gray-100 transition">Cancel</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="joinTeamModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>
        <div
            class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-blue-100">
            <form action="{{ route('teams.join') }}" method="POST">
                @csrf
                <input type="hidden" name="project_id" value="{{ $project->id }}">
                <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6 text-center">
                    <div
                    ...
                    <h3 class="text-2xl font-black text-gray-900 dark:text-gray-100 mb-2">Join Team</h3>
                    ...
                    <input type="text" name="code" required placeholder="X 7 K 9 M 2"
                        class="w-full border-2 border-blue-100 p-5 rounded-2xl uppercase text-center font-mono text-4xl tracking-[0.2em] text-gray-800 dark:text-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition placeholder-gray-200">
                </div>
                <div class="bg-gray-50 dark:bg-gray-900 px-8 py-5 flex flex-row-reverse gap-3">
                    <button type="submit"
                    ...
                    <button type="button" onclick="closeModal('joinTeamModal')"
                        class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 py-3.5 px-6 rounded-xl font-bold hover:bg-gray-100 transition">Cancel</button>
                </div>
            </form>
        </div>
    </div>
...
@if($myTeam)
    ...
    <div id="inviteMemberModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>
            <div
                class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form action="{{ route('teams.invite') }}" method="POST">
                    ...
                    <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6">
                        ...
                        <input type="email" name="email" required placeholder="student@example.com"
                            class="w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white outline-none transition shadow-inner">
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-900 px-8 py-5 flex flex-row-reverse gap-3">
                        <button type="submit"
    ...
    <div id="leaveTeamModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <span class="hidden sm:inline-block sm:align-middle sm:h-screen">&#8203;</span>
            <div
                class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border-t-8 border-red-500">
                <form action="{{ route('teams.leave') }}" method="POST">
                    ...
                    <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6">
                        <div class="flex items-center gap-4 text-red-600 mb-6">
                            ...
                            <h3 class="text-2xl font-black text-gray-800 dark:text-gray-200">Leave Team?</h3>
                        </div>
                        ...
                        @else
                            <p class="text-gray-600 dark:text-gray-400 font-medium">Are you sure you want to leave? You will lose access to all
                                tasks.</p>
                        @endif
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-900 px-8 py-5 flex flex-row-reverse gap-3">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form action="{{ route('teams.reportMember') }}" method="POST">
                    ...
                    <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6">
                        <h3 class="text-xl font-black text-gray-800 dark:text-gray-200 mb-2">Report Member</h3>
                        <div class="bg-gray-100 dark:bg-gray-900 p-3 rounded-xl mb-4 flex items-center gap-2">
                            <span class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Reporting:</span>
                            <span id="reportedUserName" class="text-gray-900 dark:text-gray-100 font-bold"></span>
                        </div>
                        <textarea name="reason" required
                            class="w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl focus:ring-gray-500 focus:border-gray-500 transition shadow-inner text-sm"
   ...
   <div id="submitTaskModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-[2rem] text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-gray-100 dark:border-gray-700">
            ...
            <form id="submitTaskForm" method="POST" enctype="multipart/form-data" class="space-y-4" x-data="{ type: 'link' }">
                ...
                <div class="p-8 space-y-6 bg-white dark:bg-gray-800">
                    ...
                    <div x-show="type === 'link'" x-transition>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Project Link (GitHub, Drive)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i class="fas fa-globe text-gray-400"></i>
                            </div>
                            <input type="url" name="link" placeholder="https://github.com/..."
                                class="w-full pl-11 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 rounded-xl p-3 text-sm focus:ring-2 focus:ring-[#266963] focus:border-[#266963] transition outline-none">
                        </div>
                    </div>

                    <div x-show="type === 'file'" x-transition style="display: none;">
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Upload File (PDF, ZIP, IMG)</label>
                        {{-- 👇👇👇 هنا كان التعديل المهم: غيرنا name="file" لـ name="submission_file" --}}
                        <input type="file" name="submission_file" 
                            class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-3 file:px-6 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-[#266963]/10 file:text-[#266963] hover:file:bg-[#266963]/20 transition cursor-pointer border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 rounded-xl p-1">
                        <p class="text-xs text-gray-400 mt-1">Max size: 100MB</p>
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Comment (Optional)</label>
                        <textarea name="submission_comment" rows="3" 
                            class="w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 rounded-xl p-4 text-sm focus:ring-2 focus:ring-[#266963] focus:border-[#266963] transition outline-none resize-none" 
                ...
                <div class="bg-gray-50 dark:bg-gray-900 px-8 py-5 flex flex-row-reverse gap-3 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <button type="button" onclick="closeModal('submitTaskModal')"
                        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 py-2.5 px-6 rounded-xl font-bold transition">
                        Cancel
                    </button>
                </div>
            </form>
