    ...
    <div class="container-fluid py-6 lg:py-8" x-data="{ 
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-8">
                <div>
                    <h2 class="text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight mb-2">
                        Join <span class="text-blue-600">Requests</span>
                    </h2>
                    <p class="text-slate-500 text-sm font-medium max-w-lg">
                ...
                <div class="flex flex-wrap items-center gap-3 bg-white dark:bg-gray-800 p-2 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <!-- ON/OFF Toggle -->
                    <div class="flex items-center gap-3 bg-slate-100 px-4 py-2.5 rounded-xl border border-slate-200 h-full" 
                         x-data="{ 
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 border border-slate-100 rounded-[1.5rem] p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    ...
                    <div class="flex items-end justify-between relative z-10">
                        <h4 class="text-4xl font-black text-slate-800 leading-none">{{ $totalCount }}</h4>
                ...
                <div class="bg-white dark:bg-gray-800 border border-slate-100 rounded-[1.5rem] p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    ...
                    <div class="flex items-end justify-between relative z-10">
                        <h4 class="text-4xl font-black text-slate-800 leading-none">{{ $pendingCount }}</h4>
                ...
                <div class="bg-white dark:bg-gray-800 border border-slate-100 rounded-[1.5rem] p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    ...
                    <div class="flex items-end justify-between relative z-10">
                        <h4 class="text-4xl font-black text-slate-800 leading-none">{{ $approvedCount }}</h4>
                ...
                <div class="bg-white dark:bg-gray-800 border border-slate-100 rounded-[1.5rem] p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    ...
                    <div class="flex items-end justify-between relative z-10">
                        <h4 class="text-4xl font-black text-slate-800 leading-none">{{ $rejectedCount }}</h4>
            ...
            <form method="GET" action="{{ route('join.admin') }}" onsubmit="handleAjaxFormSubmit(event)" class="bg-white dark:bg-gray-800 border border-slate-200 p-2 sm:p-3 rounded-2xl shadow-sm flex flex-col md:flex-row items-center gap-3 relative z-20 w-full mb-6">
                ...
                <div class="flex-1 w-full relative group">
                    ...
                    <input type="search" name="search" value="{{ request('search') }}"
                        class="w-full pl-11 pr-4 py-3 bg-slate-50 border-transparent rounded-xl text-slate-900 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 text-sm font-medium transition-all"
                ...
                <div class="flex w-full md:w-auto gap-3 shrink-0">
                    <select name="status" onchange="this.form.submit()"
                        class="flex-1 md:w-40 bg-slate-50 border border-transparent rounded-xl px-4 py-3 text-sm font-medium text-slate-700 focus:bg-white focus:border-blue-500 transition-colors cursor-pointer appearance-none">
                    ...
                    <input type="date" name="date" value="{{ request('date') }}" onchange="this.form.submit()"
                        class="flex-1 md:w-44 bg-slate-50 border border-transparent rounded-xl px-4 py-3 text-sm font-medium text-slate-700 focus:bg-white focus:border-blue-500 transition-colors cursor-pointer">
                </div>
            </form>
        </div>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="font-bold text-slate-900 text-sm" title="{{ $request->full_name }}">
                                                {{ Str::limit($request->full_name, 30) }}
                                            </div>
                                            <div class="flex items-center gap-2 mt-0.5">
                                                <span class="text-[10px] font-mono text-slate-500 bg-slate-100 p-0.5 px-1.5 rounded">{{ $request->academic_id }}</span>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-2 items-start">
                                        @if($request->status === 'pending')
                                            <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 border border-amber-200/50 rounded-md">
                                                <span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"></span>
                                                <span class="text-[10px] font-bold text-amber-600 tracking-wide uppercase">Pending</span>
                                            </div>
                                        @elseif($request->status === 'approved')
                                            <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 border border-emerald-200/50 rounded-md">
                                                <i class="fas fa-check text-emerald-500 text-[10px]"></i>
                                                <span class="text-[10px] font-bold text-emerald-600 tracking-wide uppercase">Approved</span>
                                            </div>
                                        @else
                                            <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-rose-50 border border-rose-200/50 rounded-md">
                                                <i class="fas fa-times text-rose-500 text-[10px]"></i>
                                                <span class="text-[10px] font-bold text-rose-600 tracking-wide uppercase">Rejected</span>
                                            </div>
                                        @endif
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <button @click="openViewModal({{ json_encode($request->toArray()) }})"
                                                class="w-8 h-8 bg-slate-100 text-slate-500 hover:text-blue-600 rounded-lg transition-colors flex items-center justify-center shrink-0" title="View Application">
                                            <i class="fas fa-eye text-sm"></i>
                                        </button>
                                        
                                        @if($request->status === 'pending')
                                            <button @click="openApproveModal({{ $request }})"
                                                    class="px-3 h-8 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold text-xs transition-all tracking-wide">
                                                Accept
                                            </button>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="py-16 text-center">
                                    ...
                                    <h3 class="text-sm font-bold text-slate-600">No requests found</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:hidden">
            @forelse($requests as $request)
                <div class="bg-white dark:bg-gray-800 rounded-[1.5rem] border border-slate-200 shadow-sm p-5 flex flex-col relative">
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div class="flex-1 min-w-0 pt-0.5">
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                <span class="bg-slate-100 text-slate-600 font-mono text-[10px] font-bold px-1.5 py-0.5 rounded">
                                    {{ $request->academic_id }}
                                </span>
                            </div>
                        </div>
                    ...
                    <!-- Details Row -->
                    <div class="grid grid-cols-2 gap-2 mb-4 bg-slate-50 rounded-xl p-3 border border-slate-100">
                        ...
                        <div>
                            @if($request->status === 'pending')
                                <span class="text-[11px] font-bold text-amber-600">Pending</span>
                            @elseif($request->status === 'approved')
                                <span class="text-[11px] font-bold text-emerald-600">Approved</span>
                            @else
                                <span class="text-[11px] font-bold text-rose-600">Rejected</span>
                            @endif
                        </div>
                        <div class="text-[11px] font-bold text-slate-800">{{ $request->phone_number }}</div>
                    </div>
                    ...
                    <div class="flex items-center gap-2 mt-auto">
                        @if($request->status === 'pending')
                            <button @click="openViewModal({{ json_encode($request->toArray()) }})"
                                    class="w-10 h-10 bg-slate-100 text-slate-600 rounded-xl hover:bg-slate-200 transition-colors flex items-center justify-center shrink-0">
                                <i class="fas fa-eye text-sm"></i>
                            </button>
                            <button @click="openRejectModal({{ $request }})"
                        ...
                        @else
                            <button @click="openViewModal({{ json_encode($request->toArray()) }})"
                                    class="w-full h-10 bg-slate-100 border border-slate-200 text-slate-700 rounded-xl font-bold text-xs gap-2 flex items-center justify-center">
        ...
        <div x-show="exportModal" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-2xl w-full max-w-lg relative z-10 overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
                <div class="px-6 py-5 border-b border-slate-100 bg-slate-50 text-slate-900 flex justify-between items-center">
                    ...
                    <button @click="exportModal = false" class="w-8 h-8 rounded-full bg-slate-200 text-slate-500 hover:text-red-500 flex items-center justify-center transition-colors">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-center text-sm font-bold text-slate-600 transition-all peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-600">
                                    All
                                </div>
                            </label>
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="pending" class="peer sr-only">
                                <div class="px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-center text-sm font-bold text-slate-600 transition-all peer-checked:border-amber-500 peer-checked:bg-amber-50 peer-checked:text-amber-600">
                                    Pending
                                </div>
                            </label>
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="approved" class="peer sr-only">
                                <div class="px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-center text-sm font-bold text-slate-600 transition-all peer-checked:border-emerald-500 peer-checked:bg-emerald-50 peer-checked:text-emerald-600">
                                    Approved
                                </div>
                            </label>
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="status" value="rejected" class="peer sr-only">
                                <div class="px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-center text-sm font-bold text-slate-600 transition-all peer-checked:border-rose-500 peer-checked:bg-rose-50 peer-checked:text-rose-600">
                                    Rejected
                                </div>
                            </label>
                        </div>
                            ...
                            @foreach(['full_name' => 'Full Name', 'national_id' => 'National ID', 'academic_id' => 'Academic ID', 'phone_number' => 'Phone', 'whatsapp_number' => 'WhatsApp', 'address' => 'Address', 'date_of_birth' => 'Date of Birth', 'status' => 'Status'] as $col => $label)
                                <label class="cursor-pointer group relative">
                                    ...
                                    <div class="px-3 py-2.5 rounded-xl border border-slate-200 bg-white dark:bg-gray-800 flex flex-row items-center gap-3 transition-all peer-checked:border-blue-500 peer-checked:shadow-sm">
                                        ...
                                        <span class="text-[11px] font-bold text-slate-700 capitalize truncate">{{ $label }}</span>
                                    </div>
                                </label>
                            @endforeach
                        </div>
            ...
            <div class="min-h-screen flex items-center justify-center p-3 sm:p-4">
                ...
                <div class="relative bg-white dark:bg-gray-800 w-full max-w-sm sm:max-w-xl md:max-w-3xl rounded-[1.5rem] shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[90vh]">
                    ...
                    <div class="flex justify-between items-center px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-100 bg-slate-50">
                        ...
                        <button @click="viewModalOpen = false" class="w-8 h-8 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center hover:bg-red-500 hover:text-white transition-colors">
                    ...
                    <template x-if="selectedRequest">
                        <div class="flex-1 overflow-y-auto p-4 sm:p-6 pb-6">
                            ...
                            <div class="flex items-center gap-4 border-b border-slate-100 pb-4 mb-4">
                                <div class="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 rounded-[1.2rem] overflow-hidden bg-slate-100 border border-slate-200">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h2 class="text-lg sm:text-lg font-bold text-slate-900 truncate pb-0.5" x-text="selectedRequest.full_name"></h2>
                                    <div class="flex items-center gap-2">
                                        <span class="text-[10px] font-mono font-bold bg-slate-100 px-1.5 py-0.5 rounded text-slate-700" x-text="selectedRequest.academic_id"></span>
                                    ...
                                    <div class="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center gap-3">
                                                <div class="w-7 h-7 bg-blue-100 text-blue-500 rounded-lg flex items-center justify-center"><i class="fas fa-phone-alt text-[10px]"></i></div>
                                                <span class="text-xs font-bold text-slate-800" x-text="selectedRequest.phone_number"></span>
                                            </div>
                                            <div class="flex items-center gap-3">
                                                <div class="w-7 h-7 bg-green-100 text-green-500 rounded-lg flex items-center justify-center"><i class="fab fa-whatsapp text-[10px]"></i></div>
                                                <span class="text-xs font-bold text-slate-800" x-text="selectedRequest.whatsapp_number"></span>
                                            </div>
                                            <template x-if="selectedRequest.user">
                                                <div class="flex items-center gap-3">
                                                    <div class="w-7 h-7 bg-slate-200 text-slate-500 rounded-lg flex items-center justify-center"><i class="fas fa-envelope text-[10px]"></i></div>
                                                    <span class="text-[11px] font-bold text-blue-600 truncate max-w-full" x-text="selectedRequest.user.email"></span>
                                                </div>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex justify-between items-center text-[11px]">
                                                ...
                                                <span class="font-bold text-slate-800" x-text="selectedRequest.national_id"></span>
                                            </div>
                                            <div class="flex justify-between items-center text-[11px]">
                                                <span class="text-slate-500">Resident</span>
                                                <span class="font-bold text-slate-800" x-text="selectedRequest.is_dorm == 1 ? 'Yes' : 'No'"></span>
                                            </div>
                                            <div class="flex flex-col gap-1 text-[11px] mt-2 border-t border-slate-200 pt-2">
                                                <span class="text-slate-500">Address</span>
                                                <span class="font-bold text-slate-800 leading-tight" x-text="selectedRequest.address"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
                                        <template x-for="(value, id) in selectedRequest.answers" :key="id">
                                            <div class="bg-slate-50 rounded-xl p-3 border border-slate-100">
                                                <h5 class="text-[10px] text-blue-600 font-bold mb-1 uppercase tracking-wide leading-tight" 
                                                   x-text="questionsMap[id] || (id.replace(/_/g, ' '))"></h5>
                                                
                                                <template x-if="typeof value !== 'object' || value === null">
                                                    <p class="text-slate-800 text-xs font-medium" x-text="value || 'No response'"></p>
                                                </template>
                                        ...
                                        <template x-if="!selectedRequest.answers || Object.keys(selectedRequest.answers).length === 0">
                                            <div class="border border-dashed border-slate-200 bg-slate-50 text-center py-4 rounded-xl">
                            ...
                            <template x-if="selectedRequest.status === 'pending'">
                                <div class="flex gap-2">
                                    ...
                                    <button @click="viewModalOpen = false; openApproveModal(selectedRequest)"
                                            class="w-2/3 py-3 bg-blue-600 text-white rounded-[1rem] text-sm font-bold shadow-md hover:bg-blue-700 transition-colors tracking-wide">
                                        Accept
                                    </button>
                                </div>
                            </template>
                            <template x-if="selectedRequest.status !== 'pending'">
                                <button @click="viewModalOpen = false" class="w-full py-3 bg-slate-100 border border-slate-200 text-slate-800 font-bold rounded-[1rem] text-sm">Close Layout</button>
                            </template>
                        </div>
                    </template>
                </div>
                    ...
                    <form method="POST" :action="'/join-requests/' + selectedRequest?.id + '/store-user'" onsubmit="return handleAjaxFormSubmit(event)">
                        ...
                        <div class="p-6">
                            <div class="text-center mb-6 mt-2">
                                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-50 text-blue-600 mb-4 border border-blue-100">
                                    <i class="fas fa-user-check text-2xl"></i>
                                </div>
                                <h3 class="text-xl font-bold text-slate-900">Accept Application</h3>
                                <p class="text-[11px] text-slate-500 mt-2">Set up account credentials for <span x-text="selectedRequest?.full_name" class="font-bold text-slate-800"></span>.</p>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="email" name="email" required
                                        class="w-full bg-slate-50 border bg-transparent border-slate-200 rounded-2xl px-4 py-3.5 text-sm font-semibold text-slate-900 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none">
                                </div>
                                <div>
                    ...
                    <form method="POST" :action="'/join-requests/' + selectedRequest?.id + '/reject'" onsubmit="return handleAjaxFormSubmit(event)">
                        ...
                        <div class="p-6">
                            <div class="text-center mb-2 mt-4">
                                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-rose-50 text-rose-500 mb-4 border border-rose-100">
                                    <i class="fas fa-times text-2xl"></i>
                                </div>
                                <h3 class="text-xl font-bold text-slate-900 mb-2">Reject Application</h3>
                                <p class="text-xs text-slate-500">Are you sure you want to reject <span x-text="selectedRequest?.full_name" class="font-bold text-slate-800"></span>?</p>
                            </div>
                        </div>
                        <div class="bg-slate-50 p-5 flex gap-3 border-t border-slate-100 rounded-b-3xl">
