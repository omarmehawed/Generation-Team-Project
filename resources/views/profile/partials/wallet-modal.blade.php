...
<div id="walletModal" class="hidden relative z-[100]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div
        ...
        {{-- Modal Content --}}
        <div
            class="relative w-full max-w-md transform rounded-2xl bg-white dark:bg-gray-800 text-left shadow-2xl transition-all border-t-8 border-green-500">
            <form action="{{ route('wallet.transact') }}" method="POST">
                ...
                <div class="bg-white dark:bg-gray-800 px-8 pt-8 pb-6 rounded-t-xl">
                    <div class="flex items-center gap-3 mb-6 text-green-600">
                        ...
                        <h3 class="text-xl font-black text-gray-900 dark:text-gray-100">Manage Wallet</h3>
                    </div>

                    {{-- Current Balance Display in Modal --}}
                    <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700 text-center">
                        <p class="text-xs font-bold text-gray-400 uppercase">Current Balance</p>
                        <p class="text-3xl font-black text-gray-900 dark:text-gray-100">{{ number_format($user->wallet_balance, 2) }} <span
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="cursor-pointer">
                                <input type="radio" name="type" value="deposit" class="peer hidden" checked
                                    @click="type = 'deposit'">
                                <div
                                    class="p-3 rounded-xl border-2 border-gray-100 dark:border-gray-700 text-center peer-checked:border-green-500 peer-checked:bg-green-50 transition-all hover:bg-gray-50">
                                    <p class="text-sm font-bold text-gray-600 dark:text-gray-400 peer-checked:text-green-700"><i
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div
                                    class="p-3 rounded-xl border-2 border-gray-100 dark:border-gray-700 text-center peer-checked:border-red-500 peer-checked:bg-red-50 transition-all hover:bg-gray-50">
                                    <p class="text-sm font-bold text-gray-600 dark:text-gray-400 peer-checked:text-red-700"><i
                    ...
                    <div class="mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="amount" step="0.01" min="0.01" required
                                class="w-full pl-8 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-3 text-lg font-bold focus:ring-green-500 focus:border-green-500 outline-none transition bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                                placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="notes" rows="2" maxlength="255"
                            class="w-full border-2 border-gray-200 dark:border-gray-700 rounded-xl p-3 text-sm focus:ring-green-500 focus:border-green-500 outline-none transition bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
