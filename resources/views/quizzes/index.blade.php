...
@section('content')
    <div class="max-w-6xl mx-auto py-8">
        <div class="mb-8">
            <h1 class="text-4xl font-black text-gray-800 tracking-tight"><i
                    class="fas fa-file-signature text-yellow-500 mr-2"></i> Team Quizzes</h1>
            <p class="text-gray-500 font-bold mt-2 text-lg">Test your skills and complete required assignments.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($quizzes as $quiz)
                <div
                    class="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-[0_20px_40px_-15px_rgba(234,179,8,0.3)] transition duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-bold border"><i
            ...
            @empty
                <div
                    class="col-span-full py-16 text-center bg-white rounded-3xl shadow-sm border border-dashed border-gray-300">
                    <i class="fas fa-bed text-5xl text-gray-300 mb-4 block"></i>
                    <h3 class="text-2xl font-black text-gray-800">No evaluations right now</h3>
                    <p class="text-gray-500 font-bold mt-2">Take a rest, no pending tasks available.</p>
                </div>
            @endforelse
        </div>
    </div>
