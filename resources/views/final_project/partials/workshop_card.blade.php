...
<div class="relative group transition-all duration-300">
    <div class="p-6 rounded-3xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm hover:shadow-xl transition-all duration-500 relative overflow-hidden flex flex-col h-full">
        ...
        <div class="flex justify-between items-start mb-4">
            <div class="flex-1">
                ...
                <h4 class="text-lg font-black text-gray-800 dark:text-gray-200 leading-tight group-hover:text-indigo-600 transition-colors">{{ $workshop->title }}</h4>
            </div>
        ...
        <div class="space-y-3 mb-6">
            <div class="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                <div class="w-8 h-8 rounded-xl bg-gray-50 dark:bg-gray-900 flex items-center justify-center text-indigo-500 border border-gray-100 dark:border-gray-700">
            ...
            @if($workshop->location_or_link)
                <div class="p-3 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700 mt-2">
                    ...
                    @else
                        <p class="text-xs font-bold text-gray-700 dark:text-gray-300 truncate">{{ $workshop->location_or_link }}</p>
                    @endif
                </div>
            @endif
        </div>
        ...
        <div class="mt-auto pt-4 border-t border-gray-50">
            ...
            @else
                <div class="text-center py-2 px-4 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700">
