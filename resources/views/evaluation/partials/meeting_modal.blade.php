...
<div id="meetingModal" x-data="meetingModalData()" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4">
    ...
    <div id="meetingModalContent" class="relative bg-white dark:bg-gray-800 rounded-[3rem] w-full max-w-2xl overflow-hidden shadow-2xl scale-95 opacity-0 transition-all duration-300 transform border border-gray-100 dark:border-gray-700">
        
        <div class="px-8 py-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50/50">
            <div>
                <h3 class="text-xl font-black text-gray-800 dark:text-gray-200">Schedule Internal Meeting</h3>
            ...
            <form id="scheduleMeetingForm" action="{{ route('final_project.storeInternalMeeting') }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="topic" required class="w-full bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block p-3 transition-colors" placeholder="e.g. Weekly Sync, Code Review...">
                    </div>

                    {{-- Date & Time --}}
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Date & Time <span class="text-red-500">*</span></label>
                        <input type="datetime-local" name="meeting_date" required class="w-full bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block p-3 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="cursor-pointer">
                                ...
                                <div class="p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 text-center transition-all">
                                    <i class="fas fa-video text-2xl mb-2 text-indigo-500"></i>
                                    <div class="font-bold text-gray-900 dark:text-gray-100">Online</div>
                                </div>
                            </label>
                            
                            <label class="cursor-pointer">
                                <input type="radio" name="mode" value="offline" x-model="mode" class="peer sr-only">
                                <div class="p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 peer-checked:border-green-500 peer-checked:bg-green-50 text-center transition-all">
                                    <i class="fas fa-handshake text-2xl mb-2 text-green-500"></i>
                                    <div class="font-bold text-gray-900 dark:text-gray-100">In-Person</div>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div x-show="mode === 'online'" x-cloak x-transition>
                        ...
                        <input type="url" name="meeting_link" :required="mode === 'online'" class="w-full bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block p-3 transition-colors" placeholder="https://meet.google.com/xyz...">
                    </div>
                    ...
                    <div x-show="mode === 'offline'" x-cloak x-transition>
                        ...
                        <select name="location_type" x-model="locationType" :required="mode === 'offline'" class="w-full bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block p-3 transition-colors mb-4">
                ...
                <div class="flex justify-end pt-6 mt-6 border-t border-gray-100 dark:border-gray-700">
                    <button type="button" @click="closeModal()" class="px-5 py-2.5 rounded-xl font-bold text-sm text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 transition-colors mr-3">
                        Cancel
                    </button>
