...
<div id="assignMemberModal" x-data="assignMemberModalData()"
    ...
    <div id="assignMemberModalContent"
        class="relative bg-white rounded-[3rem] w-full max-w-2xl overflow-visible shadow-2xl scale-95 opacity-0 transition-all duration-300 transform border border-gray-100">

        {{-- Header --}}
        <div
            class="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            <div>
                <h3 class="text-xl font-black text-gray-800">Add Member to Team</h3>
                <p class="text-xs text-gray-500 mt-1 font-medium">Select an unassigned member to add to your team module.</p>
            </div>
                ...
                <div x-show="step === 1" x-transition.opacity.duration.300ms>
                    <div class="mb-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h4 class="text-lg font-bold text-gray-800">Select Member</h4>
                        </div>
                ...
                <div x-show="step === 2" x-cloak x-transition.opacity.duration.300ms>
                    <div class="mb-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h4 class="text-lg font-bold text-gray-800">Confirm Assignment</h4>
                        </div>
                        
                        <div class="p-6 rounded-2xl bg-gray-50 border border-gray-100 text-center">
                            <p class="text-sm text-gray-600 mb-4 font-medium">
                                @if($isSubLeader)
                                    You are about to add <span class="font-bold text-gray-900" x-text="selectedMember?.name"></span> to your team module (Team <span class="font-bold text-indigo-500">#{{ $myMember->team_number ?? '-' }}</span>).
                                @else
                                    Select a team number to assign <span class="font-bold text-gray-900" x-text="selectedMember?.name"></span> to:
                                @endif
                            </p>
                            ...
                            <div class="mt-4 max-w-xs mx-auto">
                                ...
                                <select name="team_number" required class="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block p-3 transition-colors">
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                        <button type="button" @click="step = 1"
                            class="px-5 py-2.5 rounded-xl font-bold text-sm text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors">
