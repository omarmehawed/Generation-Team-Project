...
<div id="definePeriodModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white dark:bg-gray-800 rounded-[2.5rem] w-full max-w-lg overflow-hidden shadow-2xl scale-95 opacity-0 transition-all duration-300 transform border border-gray-100 dark:border-gray-700" id="definePeriodModalContent">
        ...
        <form action="{{ route('evaluation.store-period', $team->id) }}" method="POST" class="p-8 space-y-6">
            ...
            {{-- Week Number --}}
            <div class="space-y-2">
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Week Number</label>
                <div class="relative">
            ...
            <div class="grid grid-cols-2 gap-4">
                {{-- Start Date --}}
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Start Date</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                ...
                {{-- End Date --}}
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">End Date</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
            ...
            <div class="p-4 rounded-2xl bg-amber-50 border border-amber-100 flex gap-3">
            ...
            <div class="pt-4 flex justify-end items-center gap-4">
                <button type="button" onclick="closeModal('definePeriodModal')" 
                    class="px-6 py-2.5 rounded-xl font-bold text-gray-400 hover:bg-gray-100 transition-colors text-xs uppercase tracking-widest">Cancel</button>
                <button type="submit" 
