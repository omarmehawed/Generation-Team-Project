...
<div class="min-h-screen bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Weekly Evaluation - Software Vice Leader</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div class="rounded-2xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 p-5 shadow-sm">
                <p class="text-[10px] text-gray-400 dark:text-gray-500 font-black uppercase tracking-widest">Software Members</p>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-800">
                <h2 class="text-xl font-black text-gray-900 dark:text-white">Software Sub Leaders</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Monitor software teams and their evaluations.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse(($subLeaders ?? []) as $subLeader)
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-300">
