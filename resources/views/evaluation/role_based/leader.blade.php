...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Weekly Evaluation - Leader View</h1>
            ...
            <div class="flex flex-wrap items-center gap-3">
                <a href="{{ route('final_project.dashboard', $team->id) }}" class="rounded-xl bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 px-4 py-2 text-sm font-medium hover:bg-gray-50 transition flex items-center gap-2 shadow-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-blue-200 p-6 shadow-sm border-l-8 border-l-blue-600">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <p class="text-[10px] text-blue-600 font-black uppercase tracking-widest">Software Team</p>
                        <h3 class="text-2xl font-black mt-1 text-gray-800 dark:text-gray-200">{{ $softwareStats['members_count'] ?? 0 }} Members</h3>
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-3">
                    <div class="rounded-2xl bg-blue-50/50 p-3 border border-blue-100">
                        ...
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $softwareStats['sub_leaders'] ?? 0 }}</p>
                    </div>
                    <div class="rounded-2xl bg-amber-50/50 p-3 border border-amber-100">
                        ...
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $softwareStats['pending_reviews'] ?? 0 }}</p>
                    </div>
                    <div class="rounded-2xl bg-emerald-50/50 p-3 border border-emerald-100">
                        ...
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $softwareStats['completed_reviews'] ?? 0 }}</p>
                    </div>
                </div>
            </div>

            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-amber-200 p-6 shadow-sm border-l-8 border-l-amber-600">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <p class="text-[10px] text-amber-600 font-black uppercase tracking-widest">Hardware Team</p>
                        <h3 class="text-2xl font-black mt-1 text-gray-800 dark:text-gray-200">{{ $hardwareStats['members_count'] ?? 0 }} Members</h3>
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-3">
                    <div class="rounded-2xl bg-blue-50/50 p-3 border border-blue-100">
                        <p class="text-[9px] text-blue-600 font-black uppercase tracking-widest">Sub Leaders</p>
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $hardwareStats['sub_leaders'] ?? 0 }}</p>
                    </div>
                    <div class="rounded-2xl bg-amber-50/50 p-3 border border-amber-100">
                        <p class="text-[9px] text-amber-600 font-black uppercase tracking-widest">Pending</p>
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $hardwareStats['pending_reviews'] ?? 0 }}</p>
                    </div>
                    <div class="rounded-2xl bg-emerald-50/50 p-3 border border-emerald-100">
                        <p class="text-[9px] text-emerald-600 font-black uppercase tracking-widest">Completed</p>
                        <p class="font-black mt-1 text-gray-800 dark:text-gray-200">{{ $hardwareStats['completed_reviews'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
            ...
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-xl font-black text-gray-900 dark:text-gray-100">Software Vice Leaders</h2>
                ...
                <div class="p-6 space-y-4">
                    @forelse(($softwareViceLeaders ?? []) as $leader)
                        <div class="rounded-2xl bg-gray-50/50 border border-gray-100 dark:border-gray-700 p-4 flex items-center justify-between group hover:border-indigo-500 transition-colors">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-gray-800 dark:text-gray-200">{{ $leader->user->name }}</p>
            ...
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-xl font-black text-gray-900 dark:text-gray-100">Hardware Vice Leaders</h2>
                ...
                <div class="p-6 space-y-4">
                    @forelse(($hardwareViceLeaders ?? []) as $leader)
                        <div class="rounded-2xl bg-gray-50/50 border border-gray-100 dark:border-gray-700 p-4 flex items-center justify-between group hover:border-amber-500 transition-colors">
                            <div class="flex items-center gap-4">
