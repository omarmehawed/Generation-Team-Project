...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Weekly Evaluation - General Vice Leader</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-blue-200 p-6 shadow-sm border-t-8 border-t-blue-600 transition-transform hover:-translate-y-1">
                <p class="text-[10px] text-blue-600 font-black uppercase tracking-widest">Software Teams</p>
                <h3 class="text-3xl font-black mt-2 text-gray-800 dark:text-gray-200">{{ $stats['software_teams'] ?? 0 }}</h3>
                <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-widest">Active Units</p>
            </div>
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-amber-200 p-6 shadow-sm border-t-8 border-t-amber-600 transition-transform hover:-translate-y-1">
                <p class="text-[10px] text-amber-600 font-black uppercase tracking-widest">Hardware Teams</p>
                <h3 class="text-3xl font-black mt-2 text-gray-800 dark:text-gray-200">{{ $stats['hardware_teams'] ?? 0 }}</h3>
                <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-widest">Active Units</p>
            </div>
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-purple-200 p-6 shadow-sm border-t-8 border-t-purple-600 transition-transform hover:-translate-y-1">
                <p class="text-[10px] text-purple-600 font-black uppercase tracking-widest">Pending Reviews</p>
                <h3 class="text-3xl font-black mt-2 text-gray-800 dark:text-gray-200">{{ $stats['pending_reviews'] ?? 0 }}</h3>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
            ...
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-blue-50/50">
                ...
                <div class="p-6 space-y-4">
                    @forelse(($softwareSubLeaders ?? []) as $subLeader)
                        <div class="rounded-2xl bg-gray-50/50 border border-gray-100 dark:border-gray-700 p-4 flex items-center justify-between group hover:border-blue-500 transition-all">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-gray-800 dark:text-gray-200">{{ $subLeader->user->name }}</p>
            ...
            {{-- Hardware Side --}}
            <div class="rounded-3xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-amber-50/50">
                ...
                <div class="p-6 space-y-4">
                    @forelse(($hardwareSubLeaders ?? []) as $subLeader)
                        <div class="rounded-2xl bg-gray-50/50 border border-gray-100 dark:border-gray-700 p-4 flex items-center justify-between group hover:border-amber-500 transition-all">
                            <div class="flex items-center gap-4">
