...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Weekly Evaluation - Hardware Vice Leader</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
                <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Hardware Members</p>
        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-xl font-black text-gray-900 dark:text-gray-100">Hardware Sub Leaders</h2>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse(($subLeaders ?? []) as $subLeader)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider bg-purple-50 text-purple-600">
                                        {{ $subLeader->technical_role ?? 'Hardware' }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button onclick="openEvaluationModal('{{ $subLeader->id }}', '{{ $subLeader->user->name }}', 'sub_leader')" 
                                        class="rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-2 text-xs font-black hover:bg-gray-50 transition-all text-gray-700 dark:text-gray-300">
                                        Review
                                    </button>
                                </td>
                            </tr>
