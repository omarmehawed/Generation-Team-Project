...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.ramadan_theme' => 'boolean',
            'app.eid_theme' => 'boolean',
            ...
            'filesystems.disks.r2.visibility' => 'string',
            'filesystems.disks.r2.throw' => 'boolean',
            'filesystems.links./home/omar/Desktop/projects/Web Projects/Generation team/public/storage' => 'string',
            ...
            'pdf.custom_font_data.amiri.R' => 'string',
            'pdf.custom_font_data.amiri.useOTL' => 'integer',
            'pdf.custom_font_data.amiri.useKashida' => 'integer',
...
'app.ramadan_theme','app.eid_theme','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.report','filesystems.disks.cloudinary.driver','filesystems.disks.cloudinary.url','filesystems.disks.r2.driver','filesystems.disks.r2.key',
...
'filesystems.disks.r2.use_path_style_endpoint','filesystems.disks.r2.visibility','filesystems.disks.r2.throw','filesystems.links./home/omar/Desktop/projects/Web Projects/Generation team/public/storage','logging.default',
...
'mail.markdown.paths','pdf.mode','pdf.format','pdf.default_font_size','pdf.default_font',
'pdf.margin_left','pdf.margin_right','pdf.margin_top','pdf.margin_bottom','pdf.margin_header',
'pdf.margin_footer','pdf.orientation','pdf.title','pdf.subject','pdf.author',
'pdf.watermark','pdf.show_watermark','pdf.show_watermark_image','pdf.watermark_font','pdf.display_mode',
'pdf.watermark_text_alpha','pdf.watermark_image_path','pdf.watermark_image_alpha','pdf.watermark_image_size','pdf.watermark_image_position',
'pdf.custom_font_dir','pdf.custom_font_data.amiri.R','pdf.custom_font_data.amiri.useOTL','pdf.custom_font_data.amiri.useKashida','pdf.auto_language_detection',
'pdf.temp_dir','pdf.pdfa','pdf.pdfaauto','pdf.use_active_forms','pdf.keywords',
'pdf.creator','pdf.tempDir','pdf.pdf_a','pdf.pdf_a_auto','pdf.icc_profile_path',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','cloudinary.notification_url',
'cloudinary.cloud_url','cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','excel.exports.chunk_size',
...
'isAdmin',);
        registerArgumentsSet('routes', 'welcome','join.create','join.store','join.checkDuplicate',
'join.status','join.success','auth.google','auth.google.unlink','login','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','join.export',
'join.admin','join.toggle','join.settings.update','join.approve','join.reject',
'join.storeUser','join-questions.index','join-questions.store','join-questions.edit','join-questions.update',
'join-questions.destroy','join-questions.reorder','join-questions.toggle-visibility','join-questions.add-to-archive','join-questions.archives.store',
'join-questions.archives.show','join-questions.archives.toggle','join-questions.archives.destroy','dashboard','profile.show',
'profile.update_details','profile.update','profile.destroy','projects.index','projects.show',
'teams.store','teams.join','teams.invite','teams.leave','teams.removeMember',
'teams.promoteMember','teams.reportMember','teams.download','tasks.bulkDestroy','tasks.export',
'tasks.store','tasks.submit','tasks.approve','tasks.reject','tasks.toggle',
'tasks.destroy','tasks.deleteSubmission','tasks.download','tasks.uploadOnBehalf','notifications.accept',
'notifications.reject','notifications.check','notifications.markAsRead','notifications.readAll','posters.update_order',
'posters.edit_layout','posters.update_layout','posters.index','posters.create','posters.store',
'posters.edit','posters.update','posters.destroy','final_project.start','final_project.create',
'final_project.dashboard','final_project.logo','final_project.store','final_project.join','final_project.leave',
'final_project.toggle_group','final_project.update_logo','final_project.approve_member','final_project.reject_member','final_project.invite',
'final_project.remove_member','final_project.reportMember','final_project.submitProposal','proposal.view_file','final_project.updateMember',
'final_project.subLeaderSetup','final_project.storeExpense','final_project.updateExpense','final_project.deleteExpense','workshops.store',
'workshops.attendees','workshops.updateAttendance','workshops.destroy','final_project.storeComponent','final_project.updateComponentLock',
'final_project.updateComponent','final_project.destroyComponent','final_project.storeFund','final_project.submitPayment','funds.export',
'final_project.reviewPayment','final_project.forceWalletPayment','final_project.update_payment_settings','final_project.markPaid','final_project.storeReport',
'final_project.updateWeeklyReport','final_project.deleteWeeklyReport','final_project.requestSupervision','final_project.storeInternalMeeting','final_project.markAttendance',
'final_project.uploadGallery','final_project.deleteGallery','final_project.request_review','final_project.submit_final','final_project.export_members',
'quizzes.index','quizzes.show','quizzes.start','quizzes.retry','quizzes.attempt',
'quizzes.result','quizzes.api.step','quizzes.api.save','quizzes.api.submit','quizzes.api.violation',
'admin.quizzes.index','admin.quizzes.retries','admin.quizzes.retries.review','admin.quizzes.create','admin.quizzes.store',
'admin.quizzes.edit','admin.quizzes.update','admin.quizzes.destroy','admin.quizzes.questions','admin.quizzes.questions.store',
'admin.quizzes.questions.edit','admin.quizzes.questions.update','admin.quizzes.questions.destroy','admin.quizzes.live','admin.quizzes.live.data',
'admin.quizzes.attempts.details','admin.quizzes.attempts.observe','admin.quizzes.attempts.review','admin.quizzes.attempts.cancel','admin.quizzes.results',
'admin.quizzes.grading','admin.quizzes.grade.save','admin.quizzes.attempts.extra_time','evaluation.index','evaluation.store',
'evaluation.store-period','evaluation.assign-member','evaluation.remove-sub-leader','evaluation.autoScore','evaluation.export',
'evaluation.completeWeek','wallet.index','wallet.search','wallet.search_member','wallet.active_balances',
'wallet.transact','wallet.bulk_transact','wallet.request.submit','wallet.requests.all','wallet.requests.process',
'staff.dashboard','staff.doctor_timetable','staff.proposals','staff.proposals.decide','staff.proposal.view_file',
'staff.my_teams','staff.teams.export','staff.team.manage','staff.team.task.store','staff.report.review',
'staff.meeting.respond','staff.meeting.end','meetings.update_attendance','meeting.end','staff.team.view_as',
'staff.project.deadline','staff.team.grade','subjects.index','subjects.manage','staff.team.view',
'staff.team.save_individual_grades','staff.team.view','staff.team.save_individual_grades','staff.team.save_all_grades','staff.subject.teams.export',
'staff.team.defense','staff.system.change_term','staff.system.promote','admin.database.export','admin.activity_logs',
'admin.users','admin.users.store','admin.users.delete','admin.users.import','admin.users.import.sample',
'admin.users.update','admin.users.export','admin.users.restore','admin.users.force_delete','admin.users.bulk_update',
'admin.users.bulk_delete','admin.users.bulk_trash_action','admin.users.bulk_force_delete','admin.teams.index','admin.teams.remove_member',
'admin.teams.delete','evaluation.assign-sub-leader','storage.local',);
        registerArgumentsSet('views', 
'admin.activity_logs','admin.quizzes.create','admin.quizzes.edit','admin.quizzes.grading','admin.quizzes.index',
'admin.quizzes.live','admin.quizzes.observe','admin.quizzes.questions','admin.quizzes.questions_edit','admin.quizzes.results',
'admin.quizzes.retries','admin.quizzes.review','admin.teams&team_members_mange_DB','admin.users','admin.users_modals',
...
'components.dropdown-link','components.empty-state','components.input-error','components.input-label','components.modal',
'components.nav-link','components.primary-button','components.ramadan-theme','components.responsive-nav-link','components.secondary-button',
'components.text-input','components.user-avatar','dashboard','errors.403','errors.404',
'errors.419','errors.500','errors.503','errors.layout','evaluation.index',
'evaluation.partials.assign_member_modal','evaluation.partials.assign_sub_leader_modal','evaluation.partials.assign_task_modal','evaluation.partials.attendance_modal','evaluation.partials.define_period_modal',
'evaluation.partials.edit_team_modal','evaluation.partials.evaluation_modal','evaluation.partials.meeting_modal','evaluation.partials.workshop_modal','evaluation.role_based.default_dashboard',
'evaluation.role_based.general_vice_leader','evaluation.role_based.hardware_vice_leader','evaluation.role_based.leader','evaluation.role_based.software_vice_leader','exports.subject_teams',
'exports.teams','final_project.dashboard','final_project.error','final_project.init_team','final_project.join_landing',
'final_project.partials.modals','final_project.partials.task_card','final_project.partials.workshop_card','final_project.rejected','final_project.waiting_approval',
'join_requests.approve','join_requests.create','join_requests.index','join_requests.questions.index','join_requests.success',
'layouts.batu','layouts.exam','layouts.guest','layouts.navigation','layouts.staff',
'partials.eid-theme','partials.theme','pdf.weekly_evaluation','posters.create','posters.edit',
'posters.index','posters.layout','profile.edit','profile.partials.activity-card','profile.partials.assets-grid',
'profile.partials.delete-user-form','profile.partials.manage-role-modal','profile.partials.project-card','profile.partials.task-card','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','profile.partials.wallet-modal','profile.show','projects.index','projects.modals',
'projects.show','quizzes.attempt','quizzes.index','quizzes.result','quizzes.show',
'staff.dashboard','staff.doctor_timetable','staff.manage_team','staff.modals_manage_team','staff.my_teams',
'staff.proposals','staff.subjects.index','staff.subjects.manage_subject_project','staff.subjects.view_team','wallet.index',
'wallet.partials.modals','welcome','cloudinary::components.image','cloudinary::components.video','cloudinary::components.widget',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','RAMADAN_THEME','EID_THEME',
'CLOUDINARY_URL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','CLOUDFLARE_R2_ACCESS_KEY_ID',
'CLOUDFLARE_R2_SECRET_ACCESS_KEY','CLOUDFLARE_R2_BUCKET','CLOUDFLARE_R2_ENDPOINT','CLOUDFLARE_R2_URL','GEMINI_API_KEY',);
